package com.wanhua.wanhuamarket.utils;
...
//    public  static Drawable getDrawable2(Context context, String url){
//        Glide.with(context).asDrawable().load(url).into(new Target<Drawable>() {
//            @Override
